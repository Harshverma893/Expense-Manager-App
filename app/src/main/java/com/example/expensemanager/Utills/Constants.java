...
public class Constants {
   ...
   public static int SELECTED_TAB  = 0;
    public static void setCategories(){
        ...
        categories.add(new Category("Rent",R.drawable.ic_rent, R.color.category9));
        categories.add(new Category("Food",R.drawable.ic_food, R.color.category7));
        categories.add(new Category("Medical",R.drawable.ic_medical, R.color.category8));
        categories.add(new Category("Girlfriend",R.drawable.ic_gf, R.color.category5));
